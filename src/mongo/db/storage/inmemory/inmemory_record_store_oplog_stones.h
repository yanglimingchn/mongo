...
class InMemoryRecordStore::OplogStones {
public:
    struct Stone {
    ...
    OplogStones(OperationContext* txn, InMemoryRecordStore* rs);
    ...
    // efficiently truncate records with InMemory by skipping over tombstones, etc.
