...
class InMemoryIndex : public SortedDataInterface {
public:
    /**
     * Parses index options for wired tiger configuration string suitable for table creation.
     * The document 'options' is typically obtained from the 'storageEngine.inMemory' field
     ...
     *     'sysIndexConfig'
     *     'collIndexConfig'
     *     storageEngine.inMemory.configString in index descriptor's info object.
    ...
    /**
     * Creates a InMemory table suitable for implementing a MongoDB index.
     ...
     */
    InMemoryIndex(OperationContext* ctx, const std::string& uri, const IndexDescriptor* desc);
...
class InMemoryIndexUnique : public InMemoryIndex {
public:
    InMemoryIndexUnique(OperationContext* ctx,
...
class InMemoryIndexStandard : public InMemoryIndex {
public:
    InMemoryIndexStandard(OperationContext* ctx,
                            const std::string& uri,
                            const IndexDescriptor* desc);
