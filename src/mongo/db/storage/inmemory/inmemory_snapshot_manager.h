...
class InMemorySnapshotManager final : public SnapshotManager {
    MONGO_DISALLOW_COPYING(InMemorySnapshotManager);

public:
    explicit InMemorySnapshotManager(WT_CONNECTION* conn) {
