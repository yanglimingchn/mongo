...
class InMemoryCustomizationHooks {
public:
    static void set(ServiceContext* service,
                    std::unique_ptr<InMemoryCustomizationHooks> custHooks);

    static InMemoryCustomizationHooks* get(ServiceContext* service);

    virtual ~InMemoryCustomizationHooks() = default;
    ...
    /**
     *  Gets the InMemory encryption configuration string for the
     *  provided table name
     */
...
// Empty default implementation of the abstract class InMemoryCustomizationHooks
class EmptyInMemoryCustomizationHooks : public InMemoryCustomizationHooks {
public:
    ~EmptyInMemoryCustomizationHooks() override;
